...
class VSSBlock(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.local1 = ConvBN(hidden_dim, hidden_dim, kernel_size=1)
        self.local2 = ConvBN(hidden_dim, hidden_dim, kernel_size=3)
        self.local3 = ConvBN(hidden_dim, hidden_dim, kernel_size=5)
        self.proj = SeparableConvBN(hidden_dim, hidden_dim, kernel_size=7)
