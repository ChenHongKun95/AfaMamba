...
def get_args():
    ...
    arg("-c", "--config_path", type=Path, default='./config/loveda/afamamba.py', help="Path to  config")
    arg("-o", "--output_path", type=Path, help="Path where to save resulting masks.", default='./fig_results/loveda/afamamba-d4-test')
    arg("-t", "--tta", help="Test time augmentation.", default='d4', choices=[None, "d4", "lr"]) ## lr is flip TTA, d4 is multi-scale TTA
    arg("--rgb", help="whether output rgb masks", default = False)
