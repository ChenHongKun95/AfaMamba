...
from geoseg.DynamicMamba.AfaMamba import AFA
...
weights_name = "AfaMamba-r18-768crop-ms55"
weights_path = "model_weights/potsdam-AFA/{}".format(weights_name)
test_weights_name = "AfaMamba-r18-768crop-ms55"
