...
def get_args():
    ...
    arg("-c", "--config_path", type=Path, default='./config/potsdam/afamamba.py', help="Path to  config")
    arg("-o", "--output_path", type=Path, help="Path where to save resulting masks.", default='./fig_results/potsdam-afa/afamamba-d4')
